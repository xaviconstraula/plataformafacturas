...
export function WorkOrderFilters({
    ...
    const [sortBy, setSortBy] = useState(searchParams.get("sortBy") || "totalCost")
    ...
    }, [debouncedSearch, provider, showFilters])
    ...
    const updateUrlParams = useCallback(() => {
        ...
        router.push(`/ordenes-trabajo?${params.toString()}`, { scroll: false })
    }, [debouncedSearch, provider, sortBy, sortOrder, router])
                    ...
                    <Card className="border border-gray-200 shadow-sm">
                        ...
                        <CardContent className="p-4 space-y-4">
                            ...
                            <div className="space-y-2">
                                <Label className="text-sm text-gray-600">Buscar OT</Label>
